...
class Nave (pygame.sprite.Sprite):
    ...
    def __init__(self, posicion , vidas , puntuacion) -> None:
        super().__init__()
        #cargamos la imagen
        self.imagenes = pygame.image.load("Risky_Rescue/nave.png")
    ...
    def update(self, *args: any, **kwargs: any ) -> None:
        ...
        if self.parpadear:
            ...
            if tiempo_actual % 200 < 100:
                ...
                self.image = pygame.transform.scale(pygame.image.load("Risky_Rescue/nave.png"), (70, 100))
                #reiniciar parpadeo
...
class Enemigo(pygame.sprite.Sprite):
    def __init__(self, posicion , Nave) -> None:
        super().__init__()
        #cargamos la imagen
        imagen = [pygame.image.load("Risky_Rescue/meteorito.png"),pygame.image.load("Risky_Rescue/explosion.png") ]
...
class Fondo(pygame.sprite.Sprite):
    def __init__(self) -> None:
        super().__init__()
        # cargamos la imagen
        imagen = pygame.image.load("Risky_Rescue/nubes.jpeg")
        #pantalla
        pantalla = pygame.display.get_surface()
...
class Bala(pygame.sprite.Sprite):
    def __init__(self, posicion) -> None:
        super().__init__()
        self.image = pygame.image.load("Risky_Rescue/perla.png")
...
class Astronauta(pygame.sprite.Sprite):
    ...
    def __init__(self, posicion, nave) -> None:
        ...
        imagen_original = pygame.image.load("Risky_Rescue/astronauta.png")
